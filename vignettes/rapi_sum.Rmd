...
## Sets function
The sets function receives data from a single participant and returns a list of datasets. In this case, we will generate a list with a single element, which contains data from each of the 23 items. As this data should be split by columns, we deliver the data as a vector.
```
