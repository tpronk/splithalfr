...
## Sets function
The sets function receives data from a single participant and returns a list of datasets for each condition. In this case, we will generate four lists, containing the trials from:
...
## Score function
The score function receives these four lists from a single participant. For both the pair of practice and test blocks, the following 'block score' is calculated:
